...
{   
    ...
    public static class JiddaWrapper
    {
        ...
        [DllImport("jida.dll")]
        internal static extern bool JidaDllIsAvailable();
        ...
        /// </returns>
        [DllImport("jida.dll")]
        internal static extern bool JidaBoardOpenByNameA(string boardName, ref IntPtr pointerToBoardHandle);
        ...
        [DllImport("jida.dll")]
        internal static extern unsafe bool JidaI2CReadRegister(
            IntPtr boardHandle, int busNumber, byte address, int index, ref byte bytes);
        ...
        /// </param>
        /// <param name="data">
        /// Bytes to write to register
        /// </param>
        /// <returns>
        /// TRUE (1) on success. FALSE (0) on failure.
        /// </returns>
        [DllImport("jida.dll")]
        internal static extern unsafe bool JidaI2CWriteRegister(
            IntPtr boardHandle, int busNumber, byte address, int register, byte data);
